...
\item \textbf{Competitive accuracy at a fraction of the representation cost.} A 128-dimensional DTS vector with gradient-boosted trees matches the strongest sequence-learning baselines (MultiROCKET and a resource-matched InceptionTime), significantly outperforms the recurrent, Transformer, TCN, and ST-GCN baselines, and dominates MiniROCKET at every false-alarm budget, while remaining markedly more sample-efficient.
